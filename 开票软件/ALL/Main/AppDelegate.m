...
//    if (sessionId) {
//        [self.logModel saveSessionIdRequestSessionId:sessionId SessionIdHandler:^(NSDictionary *dic) {
//            if ([dic[@"state"] isEqualToString:@"error:nologin"]) {
...
//            }else {
//                dispatch_async(dispatch_get_main_queue(), ^ {
//                    OrdinaryViewController *or = [OrdinaryViewController new];
//                    self.window.rootViewController = or;
//                    
//                });
//            }
//            
